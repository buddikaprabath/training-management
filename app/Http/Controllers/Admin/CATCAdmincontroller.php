...
class CATCAdmincontroller extends Controller
{
    ...
    public function trainingview(Request $request, $itemId = null)
    {
        try {
            ...
            // Get the training data with filtering based on the query and division_id = 2
            $training = Training::join('divisions', 'trainings.division_id', '=', 'divisions.id')
                ->select('trainings.*', 'divisions.division_name')
                ->where('trainings.division_id', 2) // Filter by division_id = 2
    ...
    public function createtrainingview()
    {
        ...
        return view('Admin.CATCAdmin.training.create', compact('countries', 'institutes', 'trainers', 'training_codes'));
    }
    ...
    public function createtraining(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('Admin.CATCAdmin.training.Detail')->with('success', 'Training created successfully!');
        } catch (\Exception $e) {
            DB::rollBack();
    ...
    public function trainingedit($id)
    {
        try {
            ...
            return view('Admin.CATCAdmin.training.create', compact('training', 'institutes', 'trainers', 'subjects', 'countries', 'training_codes'));
        } catch (\Exception $e) {
    ...
    public function updateStatus(Request $request, $trainingId)
    {
        try {
            ...
            return redirect()->route('Admin.CATCAdmin.training.Detail', ['id' => $trainingId])
                ->with([
    ...
    public function viewCost($id)
    {
        try {
            ...
            return view('Admin.CATCAdmin.training.costDetail', compact('costs'));
        } catch (\Exception $e) {
    ...
    public function getCostBreakdownData($id)
    {
        try {
            ...
            return view('Admin.CATCAdmin.training.costbreak', compact('costs'));
        } catch (\Exception $e) {
    ...
    public function trainingdestroy($id)
    {
        try {
            ...
            DB::rollBack();
            return redirect()->route('Admin.CATCAdmin.training.Detail')->with('error', 'Error occurred while sending deletion request: ' . $e->getMessage());
        }
    }
    ...
    public function participantview($trainingId)
    {
        try {
            ...
            return view('Admin.CATCAdmin.participant.Detail', [
                'training' => $training,
    ...
    public function createparticipant($trainingId)
    {
        try {
            ...
            return view('Admin.CATCAdmin.participant.create', compact('training'));
    ...
    public function participantstore(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('Admin.CATCAdmin.training.Detail')->with('success', 'Participant added successfully! You can now upload documents.');
        } catch (\Exception $e) {
            DB::rollBack();
    ...
    public function participantedit($id)
    {
        try {
            ...
            return view('Admin.CATCAdmin.participant.create', compact('participant'));
        } catch (\Exception $e) {
