...
<div class="card">
    ...
    <div class="m-3 d-flex justify-content-between align-items-center">
        ...
        <div class="d-flex align-items-center">
            ...
            <!-- Back Button -->
            <a href="{{ route('Admin.HRAdmin.training.Detail') }}" class="btn btn-sm btn-outline-secondary">
    ...
    @if($costs) 
        <div class="container-fluid p-3">
            ...
            <div class="d-flex justify-content-end mt-4 gap-2">
                <a href="{{route('Admin.HRAdmin.training.costbreak',$costs->id)}}" class="btn btn-outline-primary">
