...
<div class="card">
    <div class="m-3 d-flex justify-content-between align-items-center">
        ...
        <a href="{{ route('Admin.HRAdmin.institute.create') }}" class="text-decoration-none">
                ...
                @foreach ($institutes as $institute)
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{route('Admin.HRAdmin.trainer.Detail',$institute->id)}}"><i data-feather="eye"></i></a>
                            <a href="{{route('Admin.HRAdmin.trainer.Create',$institute->id)}}"><i data-feather="user-plus"></i></a>
                        </td>
                        <td class="text-center">
                            <a href="{{route('Admin.HRAdmin.institute.edit',$institute->id)}}" style="display: inline"><i data-feather="edit"></i></a>&nbsp;&nbsp;
                            <form action="{{ route('Admin.HRAdmin.institute.delete', $institute->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this institute?');" style="display: inline">
                                @csrf
                                @method('DELETE')
                                <button type="submit" style="border: none; background: none; padding: 0; cursor: pointer;">
                                    <i data-feather="trash-2" class="align-middle me-2 text-danger"></i>
                                </button>
                            </form>
                        </td>
                    </tr>
