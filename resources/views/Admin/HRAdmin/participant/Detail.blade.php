                ...
                <tbody>
                    @foreach($participants as $participant)
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{route('Admin.HRAdmin.participant.edit',$participant->id)}}">
                                    <i data-feather="edit"></i>
                                </a>
                                <form action="{{ route('Admin.HRAdmin.participant.delete', $participant->id) }}" method="POST" 
...
<div class="modal fade" id="addgradeModal" tabindex="-1" aria-labelledby="addgradeModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="addGradeForm" action="{{route('Admin.HRAdmin.participant.grade.store')}}" method="POST">
                @csrf
                <div class="modal-body">
...
<script>
    const completionStatusRoute = "{{route('Admin.HRAdmin.participant.updateStatus')}}";
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        if (uploadModal) {
            uploadModal.addEventListener("show.bs.modal", function (event) {
                ...
                var formAction = "{{ route('Admin.HRAdmin.participant.documents.store', ':id') }}";
