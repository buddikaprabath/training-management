...
<div class="card card-custom">
    <div class="card-header d-flex flex-wrap justify-content-between align-items-center gap-2">
        ...
        <!-- Download Button -->
        <a href="{{ route('Admin.HRAdmin.report.pdf.download-training-summary-pdf') }}" class="btn btn-primary d-flex align-items-center px-3">
    ...
    <div class="card-body">
        <form action="{{route('Admin.HRAdmin.report.trainingSummary')}}" method="GET">
            @csrf
