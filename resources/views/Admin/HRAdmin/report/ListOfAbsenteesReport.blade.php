...
<div class="card card-custom">
    <div class="card-header d-flex flex-wrap justify-content-between align-items-center gap-2">
        ...
        <!-- Download Button -->
        <a href="{{route('Admin.HRAdmin.report.pdf.download-List-Of-Absentees')}}" class="btn btn-primary d-flex align-items-center px-3">
    ...
    <div class="card-body">
        <form action="{{route('Admin.HRAdmin.report.ListOfAbsenteesReport')}}" method="GET">
            @csrf
            <div class="d-flex flex-wrap justify-content-between align-item-center gap-2">
                <div class="mb-3">
                    <label for="Training Name" class="form-label">Course/Training Name</label>
