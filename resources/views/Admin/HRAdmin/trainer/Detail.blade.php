                ...
                <tbody>
                    @foreach ($trainers as $trainer)
                        <tr>
                            ...
                            <td>
                                <a href="{{route('Admin.HRAdmin.trainer.edit',$trainer->id)}}" style="display: inline"><i data-feather="edit"></i></a>&nbsp;&nbsp;
                                <form action="{{ route('Admin.HRAdmin.trainer.delete', $trainer->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this Trainer?');" style="display: inline">
                                    @csrf
                                    @method('DELETE')
