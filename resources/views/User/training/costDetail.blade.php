...
<div class="card">
    ...
    <div class="m-3 d-flex justify-content-between align-items-center">
        ...
        <div class="d-flex align-items-center">
            ...
            <!-- Back Button -->
            <a href="{{ route('User.training.Detail') }}" class="btn btn-sm btn-outline-secondary">
    ...
    @if($costs) 
        <div class="container-fluid p-3">
            ...
            <div class="d-flex justify-content-end mt-4 gap-2">
                <a href="{{route('User.training.costbreak',$costs->id)}}" class="btn btn-outline-primary">
                    <i data-feather="edit" class="me-1"></i> Edit
                </a>
                
                <form action="{{ route('User.training.cost-breakdown.delete', $costs->id) }}" method="POST" 
