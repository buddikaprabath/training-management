...
<html>
<head>
    <title>List of Absentees Report</title>
    <style>
        /* General Styles */
        body {
...
<body>
    ...
    <div class="header">
        ...
        <h3>List Of Absentees Report</h3>
    </div>
                ...
                @foreach($trainings as $training)
                    @foreach($training->participants as $participant)
                        <tr>
                            ...
                            <td>{{$participant->epf_number}}</td>
                            <td>{{$participant->designation}}</td>
                            <td>{{$participant->division->division_name}}</td>
                            <td>{{$training->training_period_to->format('M') }}</td>
                            <td>{{ $training->training_period_to->format('Y') }}</td>
                        </tr>
                    @endforeach
                @endforeach
            @endif
