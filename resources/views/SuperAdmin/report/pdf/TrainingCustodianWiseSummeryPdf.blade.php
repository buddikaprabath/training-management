...
<html>
<head>
    <title>Training Custodian Wise Summary</title>
    <style>
        /* General Styles */
        body {
...
<body>
    ...
    <div class="header">
        ...
        <h3>Training Custodian Wise Summary</h3>
    </div>

    <!-- Display employee details using the first participant -->
    <div class="Course-details">
        <div class="detail-row">
            <span class="label">Custodian Name:</span>
            <span class="value">{{ $custodian ?? 'N/A' }}</span>
        </div>
        <div class="detail-row">
    ...
    <table>
        <thead>
            <tr>
                <th>S/N</th>
                <th>Course/Training Programme Name</th>
                <th>Institute</th>
                <th>Trainer</th>
                <th>No. of Days</th>
